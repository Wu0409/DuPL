...
from model.model_seg_neg_v6_4_14 import siamese_network
...
parser.add_argument("--model_path", default="your_model_path/checkpoint.pth", type=str, help="model_path")

parser.add_argument("--backbone", default='vit_base_patch16_224', type=str, help="vit_base_patch16_224")
parser.add_argument("--pooling", default='gmp', type=str, help="pooling choice for patch tokens")
parser.add_argument("--pretrained", default=True, type=bool, help="use imagenet pretrained weights")

parser.add_argument("--data_folder", default='/media/store/wyc/Dataset/VOC2012/images', type=str, help="dataset folder")
...
def _validate(model=None, data_loader=None, args=None, branch=1):
    ...
    with torch.no_grad(), torch.cuda.device(0):
        ...
        for idx, data in tqdm(enumerate(data_loader), total=len(data_loader), ncols=100, ascii=" >="):
            ...
            ###
            _cams, _cams_aux = cam_helper.multi_scale_cam2_siamese(
                model, inputs=inputs, scales=[1.0, 0.5, 1.5], branch=branch
            )
            ...
            cam_aux_label = cam_helper.cam_to_label(resized_cam_aux, cls_label, bkg_thre=args.bkg_thre)

            resized_cam = cam_helper.get_valid_cam(resized_cam, cls_label)
            resized_cam_aux = cam_helper.get_valid_cam(resized_cam_aux, cls_label)
